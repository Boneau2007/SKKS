...
Die Kommunikation innerhalb von \ac{SDL} findet asynchron über Nachrichten bzw. mit diskreten Signalen (in SDL signals) über Kanäle (in \ac{SDL} channel}) statt. 
