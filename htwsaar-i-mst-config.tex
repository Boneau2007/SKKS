...
\newcommand{\myDegreeType}{Beschreibung und Vergleich von Möglichkeiten des Einsatzzweckes von Sprachen zur Beschreibung von Kommunikationsabläufen am Beispiel von SDL, UML und MSC
\xspace}
%\newcommand{\myDegreeType}{Master\xspace}

\newcommand{\myDegreeCourse}{Kommunikationsinformatik}
\newcommand{\myName}{Majdi Taher (379815) und Alexander Huber (367065)\xspace}
\newcommand{\myUni}{Hochschule für Technik und Wirtschaft des Saarlandes\xspace}

\newcommand{\myLocation}{Saarbrücken\xspace}
\newcommand{\myTime}{02.~August~2019\xspace}
